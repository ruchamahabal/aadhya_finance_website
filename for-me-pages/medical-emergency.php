        ...
        <div class="row">
            <div class="col-md-4 col-sm-8">
                <div class="serviceBox blue">
                    ...
                    <h3 class="title">Loans from Rs. 1–5 lakhs</h3>
                    <p class="description">
                    Whether it’s a tiny nick or a large procedure, our range of loan amounts lets you access the best in healthcare.
                    </p>
                </div>
            </div>
            <div class="col-md-4 col-sm-8">
                <div class="serviceBox">
                    ...
                    <p class="description">
                    Even if you can’t choose the length of your hospital visit, you can make our payment tenures of 3–48 months work for you.
                    </p>
                </div>
            </div>
            <div class="col-md-4 col-sm-8">
                <div class="serviceBox gray">
                    ...
                    <p class="description">
                    Medical emergencies don’t wait, and that’s why our approvals are instant — so you get the care you need, when you need it.
                    </p>
                </div>
            </div>
        </div>
...
<section id="docs">
  <h3 class="heading" align="center">What documents do I need to submit to apply for a personal loan for medical emergencies from Aadhya Finance?</h3>
  <div class="container-fluid">
    ...
    <div class="card">
        ...
        <h4 class="mb-0">
            <button class="btn" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                How do I avail a medical loan from Aadhya Finance?
            </button>
        </h4>
        </div>
    ...
    <div class="card">
        ...
        <h4 class="mb-0">
            <button class="btn collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
               Do I need any collateral to avail a personal loan for medical emergencies?
            </button>
        </h4>
        </div>
