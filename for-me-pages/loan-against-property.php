...
<section id="services">
     <h3 class="heading" align="center">Here’s what else you can get</h3>
     <div class="container-fluid">
        <div class="row">
            <div class="col-md-4 col-sm-8">
                <div class="serviceBox blue">
                    ...
                    <h3 class="title">Loans up to Rs 50 lakh</h3>
                    <p class="description">
                    We understand that some dreams take a lot to fulfil — that’s why our loans go up to 50 lakhs.
                    </p>
                </div>
            </div>
            <div class="col-md-4 col-sm-8">
                <div class="serviceBox">
                    ...
                    <p class="description">
                    Forget about long lines or complicated paperwork — just like you, we don’t like any delays.
                    </p>
                </div>
            </div>
            <div class="col-md-4 col-sm-8">
                <div class="serviceBox gray">
                    ...
                    <h3 class="title">Doorstep Service</h3>
                    <p class="description">
                    We show up at your door to make sure you get your loan on time.
                    </p>
                </div>
            </div>
        </div>
...
<section id="docs">
  <h3 class="heading" align="center">What documents do I need to submit with my loan against property application?</h3>
  <div class="container-fluid">
