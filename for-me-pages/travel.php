        ...
        <div class="row">
            <div class="col-md-4 col-sm-8">
                <div class="serviceBox blue">
                    ...
                    <p class="description">
                        Whether you’re planning to holiday abroad or relax at a cozy Goan resort, we won’t let money come in the way of a perfect vacation.
                    </p>
            ...
            <div class="col-md-4 col-sm-8">
                <div class="serviceBox gray">
                    ...
                    <h3 class="title">Aadhya Express</h3>
                    <p class="description">
...
<section id="docs">
  <h3 class="heading" align="center">What documents do I need to submit to apply for a personal loan for wedding from Aadhya Finance?</h3>
  <div class="container-fluid">
...
<section id="questions">
    ...
    <div class="card">
        ...
        <h4 class="mb-0">
            ...
            How do I avail a personal loan for travel from Aadhya Finance?
            </button>
        </h4>
        </div>
    ...
    <div class="card">
        ...
        <h4 class="mb-0">
            <button class="btn collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
              What will be the tenure, down-paymeny, EMI, and interest rate for my loan?
            </button>
        </h4>
        </div>
    ...
    <div class="card">
        ...
        <h4 class="mb-0">
            ...
            Do I need any collateral to avail the travel loan?
            </button>
        </h4>
        </div>
