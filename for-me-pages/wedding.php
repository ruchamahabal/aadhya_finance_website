...
<section id="services">
     <h3 class="heading" align="center">Here’s what you get along with our personal loans for weddings</h3>
     <div class="container-fluid">
        <div class="row">
            <div class="col-md-4 col-sm-8">
                <div class="serviceBox blue">
                    ...
                    <p class="description">
                        Go big or go subtle — our loans are designed to suit both your budget and style.
                    </p>
                </div>
            </div>
            <div class="col-md-4 col-sm-8">
                <div class="serviceBox">
                    ...
                    <p class="description">
                        With payment periods from 3–48 months, you don’t have to worry about EMIs on your big day.
                    </p>
                </div>
            </div>
            <div class="col-md-4 col-sm-8">
                <div class="serviceBox gray">
                    ...
                    <p class="description">
                        Loans exactly when you need it — so you can pay the florist, jeweler, and caterer right on time
                    </p>
                </div>
            </div>
        </div>
